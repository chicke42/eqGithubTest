const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją 装小智 ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza 装小智 i pobierania wiedzy z tej bazy wiedzy.',
}
