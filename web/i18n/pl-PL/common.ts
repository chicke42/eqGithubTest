const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto 装小智',
    langGeniusAccountTip: 'Twoje konto 装小智 i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do 装小智, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez 装小智 pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach 装小智.',
  ...
  about: {
    ...
    nowAvailable: '装小智 {{version}} jest teraz dostępny.',
    latestAvailable: '装小智 {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
