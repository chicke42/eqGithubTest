const translation = {
  ...
  welcome: 'Willkommen bei 装小智, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit 装小智 Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf 装小智 beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: '装小智 erkunden',
