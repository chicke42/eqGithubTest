const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou essayez la version cloud de 装小智 avec un devis gratuit',
  },
  overview: {
    title: 'Aperçu',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Aide les visiteurs à comprendre les données collectées par l\'application, voir la <privacyPolicyLink>Politique de confidentialité</privacyPolicyLink> de 装小智.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installer l\'extension Chrome 装小智 Chatbot',
        copied: 'Copié',
        copy: 'Copier',
      },
      qrcode: {
