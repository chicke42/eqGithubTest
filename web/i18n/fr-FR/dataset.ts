const translation = {
  ...
  intro1: 'La Connaissance peut être intégrée dans l\'application 装小智',
  ...
  externalAPIPanelDescription: 'L’API de connaissances externe est utilisée pour se connecter à une base de connaissances en dehors de 装小智 et récupérer des connaissances de cette base de connaissances.',
