const translation = {
  ...
  welcome: 'Bienvenue sur 装小智, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer 装小智 Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur 装小智',
  invalid: 'Le lien a expiré',
  explore: 'Explorez 装小智',
