const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte 装小智',
    langGeniusAccountTip: 'Votre compte 装小智 et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter à 装小智 pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par 装小智 vous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de 装小智.',
    link: 'Apprenez comment développer votre propre Extension API.',
    linkUrl: 'https://docs.装小智.ai/fonctionnalites/extension/extension_basee_sur_api',
  ...
  about: {
    ...
    nowAvailable: '装小智 {{version}} est maintenant disponible.',
    latestAvailable: '装小智 {{version}} est la dernière version disponible.',
  },
  appMenus: {
