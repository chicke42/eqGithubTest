const translation = {
  ...
  welcome: 'Ласкаво просимо до 装小智, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском 装小智 Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда 装小智',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте 装小智',
