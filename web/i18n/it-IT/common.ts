const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account 装小智',
    langGeniusAccountTip: 'Il tuo account 装小智 e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a 装小智 per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da 装小智 ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di 装小智.',
  ...
  about: {
    ...
    nowAvailable: '装小智 {{version}} è ora disponibile.',
    latestAvailable: '装小智 {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
