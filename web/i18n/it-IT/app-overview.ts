const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prova la versione cloud di 装小智 con quota gratuita',
  },
  overview: {
    title: 'Panoramica',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Aiuta i visitatori a capire i dati raccolti dall\'applicazione, vedi la <privacyPolicyLink>Privacy Policy</privacyPolicyLink> di 装小智.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installa l\'estensione Chrome di 装小智 Chatbot',
        copied: 'Copiato',
        copy: 'Copia',
      },
      qrcode: {
