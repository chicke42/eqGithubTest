const translation = {
  list: {
    title: 'Documenti',
    desc: 'Tutti i file della Conoscenza sono mostrati qui, e l\'intera Conoscenza può essere collegata alle citazioni di 装小智 o indicizzata tramite il plugin di Chat.',
    ...
    empty: {
      ...
      sync: {
        tip: '装小智 scaricherà periodicamente i file dal tuo Notion e completerà l\'elaborazione.',
      },
    },
    delete: {
