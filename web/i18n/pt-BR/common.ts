const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Conta 装小智',
    langGeniusAccountTip: 'Sua conta 装小智 e dados de usuário associados.',
  ...
  members: {
    ...
    invitationSentTip: 'Convite enviado e eles podem fazer login no 装小智 para acessar os dados da sua equipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'O serviço de hospedagem OpenAI fornecido pela 装小智 permite que você use modelos como GPT-3.5. Antes que sua cota de teste seja esgotada, você precisa configurar outros fornecedores de modelos.',
      callTimes: 'Chamadas',
  ...
  apiBasedExtension: {
    title: 'As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da 装小智.',
  ...
  about: {
    ...
    nowAvailable: '装小智 {{version}} já está disponível.',
    latestAvailable: '装小智 {{version}} é a última versão disponível.',
  },
  appMenus: {
