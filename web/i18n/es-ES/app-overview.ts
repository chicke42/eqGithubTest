const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prueba la versión en la nube de 装小智 con una cotización gratuita',
  },
  overview: {
    title: 'Resumen',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ayuda a los visitantes a comprender los datos que recopila la aplicación, consulta la <privacyPolicyLink>Política de privacidad</privacyPolicyLink> de 装小智.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalar la extensión de Chrome de 装小智 Chatbot',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
