const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cuenta 装小智',
    langGeniusAccountTip: 'Tu cuenta 装小智 y los datos de usuario asociados.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitación enviada, y pueden iniciar sesión en 装小智 para acceder a tus datos del equipo.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'El servicio de hospedaje OpenAI proporcionado por 装小智 te permite usar modelos como GPT-3.5. Antes de que se agote tu cuota de prueba, necesitas configurar otros proveedores de modelos.',
  ...
  apiBasedExtension: {
    title: 'Las extensiones basadas en API proporcionan una gestión centralizada de API, simplificando la configuración para su fácil uso en las aplicaciones de 装小智.',
  ...
  about: {
    ...
    nowAvailable: '装小智 {{version}} ya está disponible.',
    latestAvailable: '装小智 {{version}} es la última versión disponible.',
  },
  appMenus: {
    overview: 'Monitoreo',
    promptEng: 'Orquestar',
