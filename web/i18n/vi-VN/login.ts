const translation = {
  ...
  welcome: 'Chào mừng bạn đến với 装小智, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ email',
  ...
  license: {
    tip: 'Trước khi bắt đầu sử dụng Phiên bản Cộng đồng của 装小智, vui lòng đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội ngũ tại 装小智',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá 装小智',
