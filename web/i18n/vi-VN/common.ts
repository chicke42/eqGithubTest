const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Tài khoản 装小智',
    langGeniusAccountTip: 'Tài khoản 装小智 của bạn và dữ liệu người dùng liên quan.',
  ...
  members: {
    ...
    invitationSentTip: 'Lời mời đã được gửi, và họ có thể đăng nhập vào 装小智 để truy cập vào dữ liệu nhóm của bạn.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DÙNG THỬ',
      exhausted: 'HẾT QUOTA',
      desc: 'Dịch vụ lưu trữ OpenAI được cung cấp bởi 装小智 cho phép bạn sử dụng các mô hình như GPT-3.5. Trước khi hết lượng truy vấn dùng thử, bạn cần thiết lập các nhà cung cấp mô hình khác.',
  ...
  apiBasedExtension: {
    title: 'Các tiện ích API cung cấp quản lý API tập trung, giúp cấu hình dễ dàng sử dụng trên các ứng dụng của 装小智.',
  ...
  about: {
    ...
    nowAvailable: '装小智 {{version}} hiện đã có sẵn.',
    latestAvailable: '装小智 {{version}} là phiên bản mới nhất hiện có.',
  },
  appMenus: {
    overview: 'Giám sát',
