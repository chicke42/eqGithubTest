const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Or try the cloud version of 装小智 with free quote',
  },
  overview: {
    title: 'Overview',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see 装小智\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Install 装小智 Chatbot Chrome Extension',
        copied: 'Copied',
        copy: 'Copy',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          name: 'Fork the client code, mo装小智 it and deploy to Vercel (recommended)',
          step1: 'Fork the client code and mo装小智 it',
          step1Tip: 'Click here to fork the source code into your GitHub account and mo装小智 the code',
          step1Operation: '装小智-WebClient',
