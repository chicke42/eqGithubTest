const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to 装小智 citations or indexed via the Chat plugin.',
    addFile: 'Add file',
    addPages: 'Add Pages',
    addUrl: 'Add URL',
    table: {
    ...
    empty: {
      ...
      sync: {
        tip: '装小智 will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
