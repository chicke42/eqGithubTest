const translation = {
  ...
  account: {
    ...
    langGeniusAccount: '装小智 account',
    langGeniusAccountTip: 'Your 装小智 account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to 装小智 to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by 装小智 allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across 装小智\'s applications.',
  ...
  about: {
    ...
    nowAvailable: '装小智 {{version}} is now available.',
    latestAvailable: '装小智 {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
