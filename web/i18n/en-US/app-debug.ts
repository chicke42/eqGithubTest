const translation = {
  ...
  promptMode: {
    ...
    advancedWarning: {
      title: 'You have switched to Expert Mode, and once you mo装小智 the PROMPT, you CANNOT return to the basic mode.',
  ...
  formattingChangedText:
    'Mo装小智ing the formatting will reset the debug area, are you sure?',
  ...
  datasetConfig: {
    ...
    retrieveChangeTip: 'Mo装小智ing the index mode and retrieval mode may affect applications associated with this Knowledge.',
  },
