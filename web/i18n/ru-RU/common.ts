const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Учетная запись 装小智',
    langGeniusAccountTip: 'Ваша учетная запись 装小智 и связанные с ней пользовательские данные.',
  ...
  members: {
    ...
    invitationSentTip: 'Приглашение отправлено, и они могут войти в 装小智, чтобы получить доступ к данным вашей команды.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Хостинговая служба OpenAI, предоставляемая 装小智, позволяет вам использовать такие модели, как GPT-3.5. Прежде чем ваша пробная квота будет исчерпана, вам необходимо настроить других поставщиков моделей.',
  ...
  apiBasedExtension: {
    title: 'API-расширения обеспечивают централизованное управление API, упрощая настройку для удобного использования в приложениях 装小智.',
    link: 'Узнайте, как разработать собственное API-расширение.',
    linkUrl: 'https://docs.装小智.ai/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: '装小智 {{version}} теперь доступен.',
    latestAvailable: '装小智 {{version}} - последняя доступная версия.',
  },
  appMenus: {
    overview: 'Мониторинг',
