const translation = {
  ...
  welcome: '装小智 में आपका स्वागत है, कृपया जारी रखने के लिए लॉग इन करें।',
  email: 'ईमेल पता',
  ...
  license: {
    tip: '装小智 Community Edition शुरू करने से पहले, GitHub पर',
    link: 'ओपन-सोर्स लाइसेंस',
  },
  join: 'शामिल हों',
  joinTipStart: 'आपको आमंत्रित करते हैं',
  joinTipEnd: 'टीम पर 装小智',
  invalid: 'लिंक समाप्त हो गया है',
  explore: '装小智 का अन्वेषण करें',
