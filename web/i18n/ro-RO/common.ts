const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cont 装小智',
    langGeniusAccountTip: 'Contul 装小智 și datele de utilizator asociate.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitația a fost trimisă și pot să se autentifice în 装小智 pentru a accesa datele echipei dvs.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Serviciul de găzduire OpenAI furnizat de 装小智 vă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.',
      callTimes: 'Apeluri',
  ...
  apiBasedExtension: {
    title: 'Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile 装小智.',
  ...
  about: {
    ...
    nowAvailable: '装小智 {{version}} este acum disponibil.',
    latestAvailable: '装小智 {{version}} este ultima versiune disponibilă.',
  },
  appMenus: {
