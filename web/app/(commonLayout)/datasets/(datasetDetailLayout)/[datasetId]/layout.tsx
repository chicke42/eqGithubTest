          ...
          <a
            ...
            href={
              locale === LanguagesSupported[1]
                ? 'https://docs.zhuangxiaozhi.ai/v/zh-hans/guides/knowledge-base/integrate_knowledge_within_application'
                : 'https://docs.zhuangxiaozhi.ai/guides/knowledge-base/integrate-knowledge-within-application'
            }
...
const DatasetDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  useEffect(() => {
    if (datasetRes)
      document.title = `${datasetRes.name || 'Dataset'} - 装小智`
  }, [datasetRes])
  ...
  return (
    <div className='grow flex overflow-hidden'>
      {!hideSideBar && <AppSideBar
        ...
        icon={datasetRes?.icon || 'https://static.zhuangxiaozhi.ai/images/dataset-default-icon.png'}
